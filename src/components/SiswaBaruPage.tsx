      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/15 backdrop-blur-md p-5 border border-white/20 rounded-3xl text-white shadow-xl">
          ...
          {!props.isReadOnly && (
            ...
            >
              <img src="/logokab.png" className="w-4 h-4 text-emerald-600" />
              Input Rekap Baru
            </button>
          )}
        </div>
                                ...
                                <tr key={siswa.id} className="hover:bg-slate-50/60 transition-colors">
                                  ...
                                  <td className="px-3 py-3 text-center">
                                    <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-black ${
                                      ...
                                      {siswa.statusVerifikasi === 'Diverifikasi' ? (
                                        <img src="/logokab.png" className="w-3 h-3 text-emerald-600" />
                                      ) : siswa.statusVerifikasi === 'Ditolak' ? (
                                        <img src="/logokab.png" className="w-3 h-3 text-rose-500" />
                                      ) : (
                                        <img src="/logokab.png" className="w-3 h-3 text-amber-500" />
                                      )}
                                  ...
                                  <td className="px-3 py-3 text-center">
                                    <div className="flex items-center justify-center gap-0.5">
                                      {!props.isReadOnly ? (
                                        ...
                                        >
                                          <img src="/logokab.png" className="w-3.5 h-3.5" /> Detail
                                        </button>
                                      )}
                                    </div>
                                  </td>
